...
class ExtraIndentTest extends \WP_UnitTestCase {
    ...
    public function test_oneline() {
       $result = $this->tidy->indent( "<p>test</p>", static::INDENT_LEVEL );
        $this->assertSame( $this->indents . "<p>test</p>", $result );
    }

    public function test_twoline_cr() {
        $result = $this->tidy->indent( "<p>test</p>\r<p>test2</p>",
            static::INDENT_LEVEL );
    ...
    public function test_twoline_lf() {
        $result = $this->tidy->indent( "<p>test</p>\n<p>test2</p>",
            static::INDENT_LEVEL );
    ...
    public function test_twoline_crcr() {
        $result = $this->tidy->indent( "<p>test</p>\r\r<p>test2</p>",
            static::INDENT_LEVEL );
